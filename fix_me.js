...
function createTreeView(menu, currentNode) {
  ...
  let parent;
  if (currentNode.matches("ul")) parent = currentNode;
  else if (currentNode.matches("li")) {
  ...
  menu.forEach((element) => {
    ...
    if (element.children) createTreeView(element.children, li);
    parent.append(li);
  });

  if (currentNode.matches("li")) currentNode.append(parent);
}
